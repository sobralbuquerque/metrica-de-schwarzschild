...
#Renderizar
ax.plot_surface(
    x, y, z,  rstride=1, cstride=1, color='c', alpha=0.2, linewidth=0, zorder=0) #esfera

ax.scatter(xx, yy, zz, color="darkblue", s=20, zorder=10)  # pontos P + polos
ax.scatter(xx_0, yy_0, zz_0, color="darkblue", s=20, zorder=10)  # pontos O-Q-R-S
