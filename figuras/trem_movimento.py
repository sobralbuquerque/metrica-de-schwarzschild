...
rect = patches.Rectangle((-0.5*w, -0.5*h), w, h, linewidth=1.5, edgecolor='darkblue', facecolor='none', alpha=0.4, ls='--', zorder=5) #retangulo
rect2 = patches.Rectangle(((-0.5+dt)*w, -0.5*h), w, h, linewidth=1.5, edgecolor='darkblue', facecolor='none', alpha=0.7, zorder=0) #retangulo
ax.add_patch(rect)
ax.add_patch(rect2)
